...
{
    const subscriptionKey = 'cab089b368c4402c91a4f9de6d496e0c';
...
async function getAccessToken(subscriptionKey) {
    let options = {
        ...
        // uri: 'https://westus.api.cognitive.microsoft.com/sts/v1.0',
        headers: {
...
async function textToSpeech(accessToken, text) {
    ...
    let xml_body = xmlbuilder.create('speak')
        ...
        .ele('voice')
        .att('xml:lang', 'th-TH')
        .att('name', 'th-TH-Pattara') // Short name for '"Microsoft Server Speech Text to Speech Voice (th-TH, Pattara)"
        .txt(text)
        .end();
    ...
    let request = rp(options)
        .on('response', (response) => {
            if (response.statusCode === 200) {
                request.pipe(fs.createWriteStream('D:\\xampp\\htdocs\\voiceai\\text-to-speech-10.wav'));
                // request.pipe(fs.createWriteStream('output/text-to-speech-10.wav'));
                console.log('\nYour file is ready.\n')
            }
        });
    return request;
...
module.exports = {
    ...
    //     users: [{
    //         username: "admin",
    //         password: "$2a$08$lM6tu0BWn0Hzw3eSFZLIb.h/7Givv50OsavUXIJkVSUUGUuW9Lk4i",
    //         permissions: "*"
    //     },{
	// 		username: "test",
    //         password: "$2a$08$eBY.vVhFoSi4iE4i4WicTegXo7W5I0XxlB6/sRSQcrMjf6Ivg/5ti",
    //         permissions: "*"
	// 	}]
    // },
    ...
    // httpNodeAuth: {user:"admin",pass:"2a$08$lM6tu0BWn0Hzw3eSFZLIb.h/7Givv50OsavUXIJkVSUUGUuW9Lk4i"},
    // httpStaticAuth: {user:"admin",pass:"$2a$08$lM6tu0BWn0Hzw3eSFZLIb.h/7Givv50OsavUXIJkVSUUGUuW9Lk4i"},
    ...
    functionGlobalContext: {
        ...
        encrypt: function(text){
            ...
            try {
                ...
                var res = encrypted + cipher.final('base64');
                // log.log(req,"Encrypted : "+res);
                return res;
            } catch (error) {
                // log.log(req,"Encrypted : Fail!!!");
                return text;
            }
        },
        decrypt: function(text){
            ...
            try {
                ...
                var res = decrypted + cipher.final('utf8');
                // log.log(req,"Encrypted : "+res);
                return res;
            } catch (error) {
                console.log("Encrypted : Fail!!!");
                console.log(error);
                return text;
            }
        },
	...
	editorTheme: {
		page: {
            ...
            css: "/Users/Sc/Downloads/test.css",
            scripts: [ "/absolute/path/to/custom/script/file", "/another/script/file"]
        },
		header: {
			title: "Service-integration",
			image: "/Users/Sc/Downloads/logo.png", // or null to remove image
			url: "https://aiq-dev.dld-test.com:4001" // optional url to make the header text/image a link to this url
		},
		deployButton: {
            type:"simple",
            label:"Save",
